...
<?php
	if ($language == "JP"){
	 echo '<img id="title" src="images/produceTitleJP.png">';
	}
	else {
		echo '<img id="title" src="images/produceTitle.png">';
	}
?>
...
<script>
	...
	function yearChange(sel) {		
  	var textYear = sel.options[sel.selectedIndex].text;
        ...
        xmlhttp.open("GET", "prodprocess.php?year=" + textYear, true);
        xmlhttp.send();
    }
    ...
    function productChange(sel) {
        ...
        xmlhttp.open("GET", "prodprocess.php?year=" + textYear + "&product=" + textProduct, true);
        xmlhttp.send();
    }
    ...
    function titleChange(sel) {
        ...
        xmlhttp.open("GET", "prodprocess.php?year=" + textYear + "&product=" + textProduct + "&title=" + textTitle, true);
        xmlhttp.send();
	}
