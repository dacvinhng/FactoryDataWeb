...
if(isset($_REQUEST['ID'])){
	...
	$sql = "SELECT * FROM core0610 WHERE position = '$position'";
...
<body>
		...
		<div class="viewer1" name="viewer1">
			<div id="showimage0">
				<img id="image0" src="images/core0610.png" alt="housing">
			</div>
			<p id="line0" >CORE 0610</p>
			<?php
			if ($language == "JP"){ 
  ...
  <script>
		...
		mybackBtn.addEventListener('click', function(event) {
			<?php
			if ($language == "JP"){ 
			echo 'window.location.href = "chonmau.php?language=JP&mauHang=CORE-079612-0610";';
			}
			else{
			echo 'window.location.href = "chonmau.php?mauHang=CORE-079612-0610";';
			}
			?>
		});
		...
		function changeVN(){
			window.location.href = "CORE-0610.php";
		}

		function changeJP(){
			
			window.location.href = "CORE-0610.php?language=JP";
		}
